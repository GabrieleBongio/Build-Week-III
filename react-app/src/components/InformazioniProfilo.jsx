...
const InformazioniProfilo = () => {
	return (
		<>
			<div className="mt-7 bg-white mb-2 border border-2 rounded-3 bg-white">
				<Row>
					{/* prima sezione  */}
						...
						<Row>
							<Col>
								<div className="d-block d-lg-flex gap-1 px-1">
									<div>
										<Button variant="primary" className="m-0 p-1 px-3 border rounded-pill bg-primary text-light">
											Disponibile Per
										</Button>
									</div>
									...
									<div>
										<Button variant="outline-secondary" className="m-0 p-1 px-3 border rounded-pill">
