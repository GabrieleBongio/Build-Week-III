...
const SideBarProfile = () => {
    const otherProfile = [
        ...
        },
        {
            ...
            image: "https://compass-media.vogue.it/photos/6468fc827b0d0b8c29dbccfc/master/w_1280,c_limit/Leonardo%20DiCaprio%20Cannes%202023.jpg",
        },
        {
            name: "Valentino",
            surname: "Rossi",
            title: "Pilota Motociclistico, Pilota Automobilistico",
            image: "https://imgresizer.eurosport.com/unsafe/420x420/filters:format(jpeg):focal(144x117:146x115)/origin-imgresizer.eurosport.com/2023/11/27/3833225-77897444-310-310.jpg",
        },
        {
            name: "Miriam",
            surname: "Leone",
            title: "Attrice, Conduttrice Televisiva",
            image: "https://compass-media.vogue.it/photos/63ac19ef556c51bc7cd76488/1:1/w_2361,h_2361,c_limit/miriam-leone-struccata.jpg",
        },
        {
            name: "Vittorio",
            surname: "Sgarbi",
        ...
        },
        {
            ...
            surname: "Balotelli",
            title: "Calciatore",
            image: "https://goalist.it/app/uploads/2024/01/Acquisisci-schermata-Web_21-1-2024_10226_www.instagram.com_-768x754.jpeg",
        },
    ];
    ...
    const profileFromSchool = [
        {
            ...
            image: "https://www.artmood.it/assets/startups/68/1550398157_portrait-photography-favorite-lightness-giuseppe-gradella-04.jpg",
        },
        {
            name: "Mario",
            surname: "Giuliani",
        ...
        },
        {
            ...
            image: "https://img.freepik.com/free-photo/handsome-man-white-shirt-posing-attractive-guy-with-fashion-hairstyle-confident-man-with-short-beard-adult-boy-with-brown-hair-closeup-portrait_186202-8540.jpg",
        },
        {
            name: "Federico",
            surname: "Rocelli",
